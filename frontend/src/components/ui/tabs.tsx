...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted text-muted-foreground inline-flex space-x-1 h-9 w-fit items-center justify-start rounded-lg p-[3px]",
        className
      )}
      {...props}
    />
...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "inline-flex flex-1 items-center justify-center gap-1.5 h-[calc(100%-1px)] px-2 py-1 [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
